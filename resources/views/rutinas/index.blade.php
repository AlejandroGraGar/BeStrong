    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center gap-3 mt-6 pt-4 border-t border-gray-100">
                        <a href="{{ route('rutinas.show', $rutina) }}" class="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-2.5 px-4 rounded-xl text-center text-sm transition-colors">
                            Ver Detalles
                        </a>
                        <a href="{{ route('ejercicioRutina.update', $rutina) }}" class="p-2.5 bg-blue-50 hover:bg-blue-100 text-blue-600 rounded-xl transition-colors">
        ...
        @empty
            <div class="col-span-2 text-center py-20 bg-white rounded-2xl shadow-lg">
                ...
                <a href="{{ route('rutinas.create') }}" class="inline-block mt-6 bg-red-500 hover:bg-red-600 text-grey-600 font-bold py-3 px-6 rounded-xl shadow-lg">
                    Crear Rutina
                </a>
            </div>
        @endforelse
